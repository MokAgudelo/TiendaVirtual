...
public class Controlador {
	...
	// tarea: crear codigo para validacion de cuando se crea un usuario nuevo y tiene datos 
	//incompletos: MariEu
	
	// tarea: boton para buscar por cedula en usuario - Alejo - mensaje Debe genera un mensaje de error 
	// “Usuario Inexistente”, posteriormente, debe limpiar todos los datos ya creados.
	...
	public String actualizarUsuario(Model model, @PathVariable(name = "id") Long id) {
		...
		// TAREA: validar en tutoria mensaje confirmacion actualizacion usuario. y 
		// actualizacion de usuario con datos enblanco mensaje "“Datos faltantes”,"
		//model.addAttribute("Datos del Usuario Actualizados");
	...
	public String eliminarUsuario(Model model, @PathVariable(name = "id") Long id) {
		...
		// TAREA: mensaje " Debe genera un mensaje de información “Datos del Usuario Borrados”. " 
		// Borrado por cedula - mensaje "“Cédula Errada”," preguntar profesor Diego -
